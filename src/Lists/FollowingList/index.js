...
const FollowingList = () => {
  ...
  return (
    <div className={styles.followingList}>
        <FollowItem name= "Piz11za"  content="Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt reprehenderit elit laborum. " following={true}/>
